...
5. **Stage closing prompt:** Each stage must end with its specified 💡 prompt verbatim. This prompt is a mandatory closing marker, not a sub-section — it is always emitted.
